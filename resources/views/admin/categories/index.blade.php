                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col">
                                                        {!! Form::open(['class' => 'form-horizontal', 'action' => ['Admin\CategoryController@update', $category->id], 'method' => 'POST']) !!}
    ...
    <div class="modal fade" id="add" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {!! Form::open(['class' => 'form-horizontal', 'action' => 'Admin\CategoryController@store', 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
