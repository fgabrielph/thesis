                                        ...
                                        @foreach($deliveries as $delivery)
                                            @if($delivery->status == 'On Delivery' && $delivery->order->status != 'Canceled')
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{route('staff_deliveries.status', ['status' => 'Completed', 'id' => $delivery->id])}}" class="btn btn-lg btn-success">Complete</a>
                                                        <a href="{{route('staff_deliveries.status', ['status' => 'Return', 'id' => $delivery->id])}}" class="btn btn-lg btn-primary">Return</a>
                                                    </td>
                                                ...
                                                <div class="modal fade" id="deliver{{$delivery->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            <form action="{{route('staff_deliveries.edit_eda', $delivery->id)}}" class="form-horizontal" method="POST">
                                                                @csrf
